...
def ma_support_resistance(df, period, tolerance=0.015, min_touches=2, recent_window=3):
    """
...
# async def is_price_near_ma(df, ma_period=10, tolerance=0.001):
#   """
...
async def check_ema(df, period=200, tolerance=0.015):
...
async def is_price_near_bollinger_band(df, period=20, std_dev=2, tolerance=0.015):
  """
